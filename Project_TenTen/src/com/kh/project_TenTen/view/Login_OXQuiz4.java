...
public class Login_OXQuiz4 extends JPanel {
	private Login_MainFrame mf;
	private JPanel login_OXQuiz4;
	int q1 = 0;
	int q2 = 0;
	int q3 = 0;
	int q4 = 0;
	...
	public Login_OXQuiz4(Login_MainFrame mf) {
		this.mf = mf;
		login_OXQuiz4 = this;
		...
		btnFinish.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ChangePanel.changePanel(mf, login_OXQuiz4, new Login_MainPage(mf));
