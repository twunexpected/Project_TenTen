...
public class Login_OXQuiz3 extends JPanel {
	...
	public Login_OXQuiz3(Login_MainFrame mf) {
		this.mf = mf;
		login_OXQuiz3 = this;
		...
		btnFinish.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ChangePanel.changePanel(mf, login_OXQuiz3, new Login_MainPage(mf));
