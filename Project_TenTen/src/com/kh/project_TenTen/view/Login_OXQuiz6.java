	...
	public Login_OXQuiz6(Login_MainFrame mf) {
		...
		btnFinish.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ChangePanel.changePanel(mf, login_OXQuiz6, new Login_MainPage(mf));
