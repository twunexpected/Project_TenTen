	...
	public Login_OXQuiz2(Login_MainFrame mf) {
		...
		btnFinish.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ChangePanel.changePanel(mf, login_OXQuiz2, new Login_MainPage(mf));
