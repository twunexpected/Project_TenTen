...
import com.kh.project_TenTen.controller.controller;
import java.util.*;
public class Test_Select4_new1 extends JPanel{
	...
	public static void main(String[] args)
    {
		...
		String str1 = Integer.valueOf(brr[0]).toString();
		String str2 = Integer.valueOf(brr[1]).toString();
		String str3 = Integer.valueOf(brr[2]).toString();
		String str4 = Integer.valueOf(brr[3]).toString();
		String str5 = Integer.valueOf(brr[4]).toString();
...
//		lbTop.setFont(new Font(" ", Font.BOLD, 10));
		...
		JTextField tfWord = new JTextField(count);
